...
public class Book extends javax.swing.JFrame {
    ...
    public void Book_Load() {
        try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("b.bname"));
                v.add(rs.getString("c.catname"));
                v.add(rs.getString("a.name"));
                v.add(rs.getString("p.name"));
                v.add(rs.getString("b.contents"));
                v.add(rs.getInt("b.pages"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object[][]{},
            new String[]{"ID", "Book Name", "Category", "Author", "Publisher", "Contents", "Pages", "Edition"}
        ));
